...
def seed_database():
    ...
    listings_data = [
        ...
        },
        {
            ...
            "title": "Modern Sky Suite overlooking Sector 75",
            "description": "Stylishly designed 2BHK high-rise apartment with floor-to-ceiling balcony views, ambient warm lighting, Italian marble flooring, and smart home features. Located right by Spectrum Mall with seamless metro connectivity.",
            "property_type": "Flat",
            "category": "popular",
            "city": "Noida",
            "state": "Uttar Pradesh",
